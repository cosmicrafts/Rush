...
async function main() {
    ...
    if (!targetAddress) {
        ...
        console.log("Usage: TARGET_ADDRESS=0x1234... npx hardhat run scripts/fund-wallet.js --network localhost");
        console.log("Optional: TARGET_ADDRESS=0x1234... AMOUNT=5 npx hardhat run scripts/fund-wallet.js --network localhost");
        process.exit(1);
    }
    ...
    try {
        ...
        console.log("Amount received:", ethers.utils.formatEther(balanceAfter.sub(balanceBefore)), "ETH");
