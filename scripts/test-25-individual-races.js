...
main()
    .then((results) => {
        ...
        console.log(`🎯 Key finding: Standard deviation of ${results.standardDeviation} indicates ${results.standardDeviation < 12 ? 'good balance' : results.standardDeviation < 20 ? 'moderate balance' : 'poor balance'}`);
