<template>
  ...
  >
    ...
    >
      ...
      <div
        class="relative w-full max-w-lg mx-auto bg-gradient-to-tr from-gray-900 via-black to-gray-900 shadow-2xl border border-cyan-500/30 overflow-hidden backdrop-blur-sm"
      >
        ...
        <div class="relative p-6 space-y-6">
          ...
          <div class="text-center space-y-4">
            ...
            <div class="space-y-3 text-sm text-gray-300 leading-relaxed">
              ...
              <div
                class="flex items-center justify-center space-x-2 p-3 bg-amber-900/20 border border-amber-500/30 rounded-lg"
              >
