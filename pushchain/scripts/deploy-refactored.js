...
async function main() {
  ...
  console.log(`SPACESHIP_RACE_CORE_ADDRESS=${spaceshipRaceCoreAddress}`)
  console.log(`PLAYER_STATS_MANAGER_ADDRESS=${statsManagerAddress}`)
  console.log(`PLAYER_PROFILE_MANAGER_ADDRESS=${profileManagerAddress}`)
  console.log(`ACHIEVEMENT_MANAGER_ADDRESS=${achievementManagerAddress}`)
