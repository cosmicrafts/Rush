    ...
    >
      ...
      >
        ...
        <div class="absolute inset-0 overflow-hidden pointer-events-none">
          <div class="absolute top-1/4 left-1/4 w-3 h-3 bg-cyan-400 rounded-full animate-pulse opacity-60"></div>
          <div class="absolute top-3/4 right-1/4 w-2 h-2 bg-pink-500 rounded-full animate-ping opacity-50"></div>
          <div class="absolute bottom-1/4 left-1/3 w-2 h-2 bg-cyan-400 rounded-full animate-bounce opacity-60"></div>
        </div>
        ...
        <div class="relative w-full max-w-4xl mx-auto bg-gradient-to-tr from-gray-900 via-black to-gray-900 shadow-2xl border border-purple-500/30 overflow-hidden backdrop-blur-sm">
          ...
          <div class="relative max-h-[70vh] overflow-y-auto">
            ...
            <div v-if="showAchievementsTab" class="p-6 space-y-4 min-h-[600px]">
              ...
              <div v-else-if="achievementsLoaded && allAchievements.length > 0" class="space-y-4">
                <!-- Achievement Summary -->
